#!/usr/bin/env node
/**
 * Provisioning automatico PortePro su Vercel
 *
...
const PROJECT_NAME = process.env.PORTE_PROJECT_NAME || "portepro";
...
async function main() {
  console.log("=== PortePro — Deploy automatico Vercel ===\n");
  ...
  console.log(`   VERCEL_PROJECT_ID_PORTE=${project.id}`);
  console.log("\n   Per Firebase, aggiungi in Vercel le variabili da apps/porte/.env.example");
}
