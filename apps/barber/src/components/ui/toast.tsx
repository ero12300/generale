  ...
  <ToastPrimitives.Root
    ...
    className={cn(
      ...
      variant === 'destructive'
        ...
        : 'border-[rgba(212,175,55,0.2)] bg-[rgb(18,18,18)] text-[rgb(250,245,235)]',
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Action
    ref={ref}
    className={cn(
      'inline-flex h-8 shrink-0 items-center justify-center rounded-md border border-[rgba(212,175,55,0.3)] bg-transparent px-3 text-sm font-medium transition-colors hover:bg-[rgba(212,175,55,0.1)] focus:outline-none focus:ring-2 focus:ring-[rgb(212,175,55)]',
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Close
    ref={ref}
    className={cn(
      'absolute right-2 top-2 rounded-md p-1 text-[rgb(140,130,110)] opacity-0 transition-opacity hover:text-[rgb(250,245,235)] focus:opacity-100 focus:outline-none focus:ring-2 group-hover:opacity-100',
      className
    )}
    toast-close=""
    {...props}
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Description
    ref={ref}
    className={cn('text-sm text-[rgb(140,130,110)]', className)}
    {...props}
  />
))
