...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gold/50 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default:
          "bg-gradient-to-b from-[#e3c680] to-[#c9a24b] text-zinc-950 hover:from-[#eccf8f] hover:to-[#d4ae57] shadow-[0_8px_20px_-10px_rgba(201,162,75,0.8)] font-semibold",
        secondary:
          "bg-zinc-800 text-zinc-100 hover:bg-zinc-700 border border-zinc-700",
        outline:
          "border border-[#c9a24b]/40 bg-transparent text-gold-soft hover:bg-[#c9a24b]/10",
